...
class SimpleANN(nn.Module):
    def __init__(self, input_size):
        ...
        self.fc1 = nn.Linear(input_size, 128)  # Further reduced layer size
        self.fc2 = nn.Linear(128, 64)          # Further reduced layer size
        self.fc3 = nn.Linear(64, 32)           # Further reduced layer size
        self.fc4 = nn.Linear(32, 16)           # Further reduced layer size
...
# If GPU runs out of memory, use the following line instead
